<div class="sidebar-filter wb-ihsn-sidebar-filter filter-box keyword-search">
    ...
    <div id="search-by-keyword" class="search-by-keyword sidebar-filter-entries">
       ...
       <?php /* <div class="form-group variable-search">
        ...
        <button type="submit" id="btnsearch" name="search" value="<?php echo t('search');?>" class="btn btn-primary btn-sm wb-btn btn-search">Search</button>
